...
<script>
  function populateCompanyName() {
    ...
    document.getElementById("quota_company_contact_user").value = selectedCompany.company_contact_user;

    document.getElementById("quota_company_phone").value = selectedCompany.company_phone;

    document.getElementById("quota_company_email").value = selectedCompany.company_email;

    document.getElementById("quota_contact_person_secondary").value = selectedCompany.contact_person_secondary;

    document.getElementById("quota_contact_no_secondary").value = selectedCompany.contact_no_secondary;

    document.getElementById("quota_company_email_secondary").value = selectedCompany.company_email_secondary;
...
function addContactField() {
    ...
    var contactBody = document.getElementById('contact_body');
...
<!-- Heading for Create Activity  -->
 ...
 <!-- Add product button -->
	...
	<div style="text-align: right; margin-bottom: 10px;"><button id="add-field" onclick="addField()" type="button" title="Add Product" class="md:w-full text-white py-2 px-4 rounded-full addfield" style="width: 100px; text-align: center; background-color: black; border: 1px solid #000 !important;"> + </button> <input type="hidden" name='hid_count' id='hid_count' value='2'></div>
        <div class="field-row">
...
maxlength="100" minlength="1" style="width: 100%;">
                  ...
                  <td><input name="invoice_quality[]" onchange="updateRate('1')" required class=" text-black border border-gray-200 rounded py-3 px-4 mb-3 cls_prdqty" id="invoice_quality_1" title="Product Quantity" type="number" style="width: 100%" placeholder="Quantity" max="999999999999" min="1"></td>
                  ...
                  <td>
                    <!-- Product rate onchange field -->
                    <input name="invoice_rate[]" onchange="updateRate('1')" required class=" text-black border border-gray-200 rounded py-3 px-4 mb-3 cls_prdrate" id="invoice_rate_1"  title="Product Rate" type="text" style="width: 100%" placeholder="Rate" maxlength="10" minlength="1">
                  </td>
                  <!-- Product Gst onchange field -->
                  <td><input name="invoice_gst[]" onchange="updateRate('1')" required class=" text-black border border-gray-200 rounded py-3 px-4 mb-3 update_min_vlu" id="invoice_gst_1" title="Product Gst" type="number" style="width: 100%" placeholder="GST" min="1" max="99" value="18"></td>
                  <!-- Product total amount onchange field -->
                  <td><input name="invoice_total[]" readonly required class=" text-black border border-gray-200 rounded py-3 px-4 mb-3 cls_prdtotal" id="invoice_total_1" title="Product Total" type="number" style="width: 100%" placeholder="Total" max="999999999999" min="1"></td>
                  <!-- Remove product button -->
                  <td><button onclick="removeField(this)" type="button" class="md:w-full mt-1 text-white py-2 px-4 rounded-full removefield" style="background-color: black; width: 100px; border: 1px solid #000 !important;" title="Remove Product">-</button></td>
                </tr>
		</tbody>
              </table>
  ...
  function addField() {
    ...
    <td> <select name="invoice_product_name[]" id="invoice_product_name_` + hid_count + `" onchange="populateProductName(` + hid_count + `)" required class="text-black border border-gray-200 rounded py-3 px-4 mb-3 invoice_product_name_list" maxlength="100" minlength="1" style="width: 100%">
        ...
        <td><input name="invoice_quality[]" onchange="updateRate(` + hid_count + `)" required
            class="text-black border border-gray-200 rounded py-3 px-4 mb-3 cls_prdqty" id="invoice_quality_` + hid_count + `" title="Product Quantity"
        ...
        <td><input name="invoice_rate[]" onchange="updateRate(` + hid_count + `)"  required
            class="text-black border border-gray-200 rounded py-3 px-4 mb-3 cls_prdrate" id="invoice_rate_` + hid_count + `" title="Product Rate"
            ...
            <input name="invoice_rate_hidden[]" onchange="updateRate(` + hid_count + `)" required
                    class="text-black border border-gray-200 rounded py-3 px-4 mb-3" id="invoice_rate_hidden_` + hid_count + `" title="Product Rate"
                    type="hidden" style="width: 100%"  placeholder="Rate"> 
            </td>  
        <td><input name="invoice_gst[]" onchange="updateRate(` + hid_count + `)" required
            class="text-black border border-gray-200 rounded py-3 px-4 mb-3 update_min_vlu" id="invoice_gst_` + hid_count + `" title="Product Gst"
            type="number" style="width: 100%" placeholder="GST" min="1" max="99" value="18"></td>
            <td><input name="invoice_total[]" readonly required
            class="text-black border border-gray-200 rounded py-3 px-4 mb-3 cls_prdtotal" id="invoice_total_` + hid_count + `" title="Product Total"
            type="number" style="width: 100%" placeholder="Total" max="999999999999" min="1"></td>
    <!-- Other fields here -->
    <td><button onclick="removeField(this)" type="button" class="md:w-full mt-1 text-white py-2 px-4 rounded-full removefield" 
style="background-color: black; width: 100px; border: 1px solid #000 !important;" title="Remove Product">-</button>
    </td>
    `;
