...
<body translate="no">
<!-- Company Logo in top of the pdf sheet  -->
  <div id="header" style="width:90%">
    <table style="width:100%">
      <tr>
        <td style="text-align: right; width:100%;">
          <h1><img src="../public/css/celebmedia_logo.png" style="width: 310px;"></h1>
        </td>
      </tr>
    </table>
  </div>
  ...
  <main style="padding-top:150px;">
    <table style="width:100%">
      <tr>
        ...
        <!-- Headline of the pdf sheet -->
          <table style="width: 100%; padding: 10px;">
            <tr>
             ...
             <!-- Company details section in the pdf sheet -->
	    <tr>
            ...
            <tr>
                    ...
                    <td style="width: 98%; padding-left: 2%;">
                      <table style="width: 100%;">
                        ...
                        <tr>
                          ...
                          <td style=" text-transform: uppercase;">: @foreach ($invoice_data as $invoice_data_value)
                            {{ $client_state = $invoice_data_value->company_state }}
                            @endforeach
                          </td>
                        </tr>
                           <!-- Pincode Section -->
              ...
              <td
                ...
                <!-- QUOTATION SUMMARY Details Section in pdf sheet -->
                <table style="width: 100%;">
                  <tr>
                    <td style="width: 98%; padding-left: 2%;">
                      <table style="width: 100%;">
			...
			<tr>
                          ...
                          <td style=" text-transform: uppercase; width: 72%; padding-top:5px;">
			  @foreach ($invoice_data as $invoice_data_value)
                            {{ $invoice_data_value->received_date }}
                          @endforeach
			  </td>
                        </tr>
                        <tr>
			...
			<tr>
                          ...
                          <td style=" font-weight: bold; width: 2%">: </td>
                          <td style=" text-transform: uppercase;">@if($invoice_data_value->po_details != '') {{ $invoice_data_value->po_details }} @else {{ "-" }} @endif</td>
                        </tr>
        ...
        <!-- Activity Details Section in Pdf sheet -->
	    <tr>
              <td colspan="2" style="width: 100%; height: 5px;"></td>
            </tr>
		...
		<span style=" text-transform: uppercase;">{{ $invoice_data_value->activity_details }}</span>
            ...
            <tr>
             ...
             <!-- Product Column name Section in Pdf sheet -->
            <tr>
                ...
                <table style="width: 100%;">
                  <thead>
                    <tr style="line-height: 20px !important; height: auto;">
                      ...
                      <th
                        style="font-weight: bold; padding-bottom: 5px; background-color: #000; color: #FFF; width:30%">
                        Particulars</th>
                      <th
                      ...
                      <th
                        ...
                        Amount</th>
		      @if(strtoupper($current_state) == strtoupper($client_state))
			<th
                        style="font-weight: bold; padding-bottom: 5px; background-color: #000; color: #FFF; width:8%">
                        CGST
                      	</th>
			<th
                        style="font-weight: bold; padding-bottom: 5px; background-color: #000; color: #FFF; width:8%">
		      ...
		      @endif
                  ...
                  <!-- Product Details Section in Pdf sheet -->
                  <tbody>
		      ...
		      @if(strtoupper($current_state) == strtoupper($client_state))
			@php $split_percentage = ($product_data_value->prd_gst_percentage / 2); $split_gst_amount = ($product_data_value->prd_gst_amount / 2); @endphp
			<td style="border: 1px solid #000; text-align: center; padding-bottom: 5px;">
                        <span>{{ $split_gst_amount }} ({{ $split_percentage }}%)</span>
                      	</td>
			<td style="border: 1px solid #000; text-align: center; padding-bottom: 5px;">
                        <span>{{ $split_gst_amount }} ({{ $split_percentage }}%)</span>
                      	</td>
		      @else
                      <td style="border: 1px solid #000; text-align: center; padding-bottom: 5px;">
                        <span>{{ $product_data_value->prd_gst_amount_format }} ({{ $product_data_value->prd_gst_percentage }}%)</span>
                      </td>
		      @endif
                      <td
                  ...
                  <!-- Grand Total Amount Section in Pdf sheet -->
                  <tfoot>
                    <tr style="line-height: 20px !important; height: auto;">
                      <th colspan="3"></th>
		      @if(strtoupper($current_state) == strtoupper($client_state))
			@php $clspn = 4; $grnd_clspn = 8; @endphp
		      @else
			@php $clspn = 3; $grnd_clspn = 7; @endphp
		      @endif
                      ...
                      <th colspan="{{ $clspn }}"
                        ...
                        Grand Total in <img src="../public/css/white-rupee-indian.png" style="width: 8px !important; height: 8px !important; border: 0px; vertical-align: middle; margin-top: 10px;"> (Round Off)
                      </th>
                      <th
                     ...
                     <!-- Grand Total Amount in words Section in Pdf sheet -->
                    <tr>
                      <th colspan="{{ $grnd_clspn }}"
            ...
            <tr>
              <td
                ...
                <table style="width: 100%;">
                  <tr>
                    <td style="width: 98%; padding-left: 2%;">
                       <!-- Company Details Section in Pdf sheet -->
                      <table style="width: 100%;">
                        <tr>
			...
			@foreach ($bank as
                        ...
                        <tr>
                          ...
                          <td style=" text-transform: uppercase; width:72%">: {{ $bank_data->company_name }}</td>
                        </tr>
                        <tr>
                          <td style=" font-weight: bold;">Bank Name</td>
                          <td style=" text-transform: uppercase;">: {{ $bank_data->bank_name }}</td>
                        </tr>
                        <tr>
                          <td style=" font-weight: bold;">Account No</td>
                          <td style=" text-transform: uppercase;">: {{ $bank_data->bank_account_no }}</td>
                        </tr>
                        <tr>
                          <td style=" font-weight: bold;">IFSC Code</td>
                          <td style=" text-transform: uppercase;">: {{ $bank_data->bank_ifsc_code }}</td>
                        </tr>
                        @endforeach
                      </table>
                    </td>
		...
		<tr>
             ...
             <!-- Signature Section in Pdf sheet -->
            <tr>
...
<div id="footer">
     <!-- Footer Company Details Section in Pdf sheet -->
